  ...
  const jobs = [
    {
      ...
      text: "Drive growth by identifying leads and closing high-value deals.",
    },
    {
      id: "02",
      title: "Sales Executive",
      text: "Manage pipelines and convert prospects into long-term clients.",
    },
    {
      id: "03",
      title: "UI/UX Designer",
      text: "Design clean, modern, user-focused interfaces.",
    },
    {
      id: "04",
      title: "Full Stack Developer",
      text: "Build scalable web apps using modern tech.",
    },
    {
      id: "05",
      title: "Frontend Developer",
      text: "Craft pixel-perfect UI with animations.",
    },
  ];
  ...
  return (
    ...
    >
      <div style={{ maxWidth: "min(1200px,92vw)", margin: "0 auto" }}>
        ...
        {/* JOB LIST */}
        <div style={{ borderTop: "1px solid #ddd", marginBottom: "100px" }}>
          {jobs.map((job, index) => (
            <JobRow
              key={index}
              job={job}
        ...
        <motion.footer
          ...
          style={{
            background: "#111",
            color: "#fff",
            padding: "clamp(32px,6vw,90px) clamp(16px,4vw,40px)",
            borderRadius: "12px",
            textAlign: "center",
          }}
        >
          ...
          <p style={{ color: "#aaa", marginBottom: "30px" }}>
            We’re building a team of creators, thinkers, and builders.
          </p>
...
const JobRow = ({ job, onApply, isMobile }) => {
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        gridTemplateColumns: isMobile
          ? "1fr"
          : "80px minmax(200px,1fr) minmax(250px,2fr) auto",
    ...
    >
      ...
      <div style={{ zIndex: 1, color: hover ? "#666" : "#aaa" }}>
        [{job.id}]
      </div>
